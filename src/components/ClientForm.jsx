  ...
  return (
    <Box>
      ...
      <form onSubmit={formik.handleSubmit}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6} lg={4}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={formik.touched.subAddresses && Boolean(formik.errors.subAddresses)}
                helperText={formik.touched.subAddresses && formik.errors.subAddresses}
                size="small"
                margin="dense"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6} lg={4}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={formik.touched.idPassport && Boolean(formik.errors.idPassport)}
                helperText={formik.touched.idPassport && formik.errors.idPassport}
                size="small"
                margin="dense"
              />
            </Grid>
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          <Typography variant="h6" sx={{ mb: 2 }}>Client Category</Typography>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth size="small" margin="dense">
                <InputLabel id="salesType-label">Sales Type</InputLabel>
                <Select
            ...
            <Grid item xs={12} md={6} lg={3}>
              <FormControl fullWidth size="small" margin="dense">
                <InputLabel id="taxStatus-label">TaxStatus</InputLabel>
                <Select
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
            <Typography variant="h6" sx={{ mr: 2 }}>Service</Typography>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mr: 4 }}>
                  <Checkbox
                    checked={formik.values.loyalClient}
                    onChange={formik.handleChange}
                    name="loyalClient"
                    size="small"
                  />
                  <Typography variant="body2">Loyal Client</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Checkbox
                    checked={formik.values.credit}
                    onChange={formik.handleChange}
                    name="credit"
                    size="small"
                  />
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Checkbox
                    checked={formik.values.closeOverdue}
                    onChange={formik.handleChange}
                    name="closeOverdue"
                    size="small"
                  />
                  <Typography variant="body2">Clients Overdue</Typography>
                </Box>
              </Box>
            </Grid>
            <Grid item xs={12}>
              <Box sx={{
                ...
                <Typography variant="subtitle2" sx={{ mb: 1 }}>Treatment credits</Typography>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      ...
                      size="small"
                    />
                    <Typography variant="body2">Supplieer</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      checked={formik.values.exeTVA}
                      onChange={formik.handleChange}
                      name="exeTVA"
                      size="small"
                    />
                    <Typography variant="body2">Exe. TVA</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      checked={formik.values.payTVA}
                      onChange={formik.handleChange}
                      name="payTVA"
                      size="small"
                    />
                    <Typography variant="body2">Pay TVA Non Declare</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      checked={formik.values.vatCredit}
                      onChange={formik.handleChange}
                      name="vatCredit"
                      size="small"
                    />
                    <Typography variant="body2">Vente Credit</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      checked={formik.values.asProv}
                      onChange={formik.handleChange}
                      name="asProv"
                      size="small"
                    />
                    <Typography variant="body2">A/S Prov</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 150 }}>
                    <Checkbox
                      checked={formik.values.defaultFreeze}
                      onChange={formik.handleChange}
                      name="defaultFreeze"
                      size="small"
                    />
                    <Typography variant="body2">Default Freeze</Typography>
                  </Box>
                </Box>
              </Box>
            </Grid>
